        ...
        <div class="main-dashboard d-flex">
            <div class="sidebar" id="side_nav">
                ...
                <ul class="list-unstyled px-2">
                    ...
                    <li class="py-1 border border-top-0 border-start-0 border-end-0 " data-id="2"><a href="#"
                            class="text-decoration-none text-white px-3 py-2 d-block">Profile</a></li>


                    <li class="py- border border-top-0 border-start-0 border-end-0" data-id="3"><a href="#"
                    ...
                    <li class="py-1 border border-top-0 border-start-0 border-end-0" data-id="6"><a href="#"
            ...
            <div class="content-box">
                <div class="content ms-5 mt-5 content-open" data-id="1">
                    <h3 class="fs-bold">Greetings messages to manager</h3>
                ...
                <div class="content ms-5 mt-5 content-open" data-id="2">
                    ...
                    <button class="btn btn-secondary btn-sm mb-2 w-25">View Profile</button>
                </div>
